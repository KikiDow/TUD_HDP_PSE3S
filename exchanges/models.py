...
class ExchangeRequest(models.Model):
    ...
    exchanging_req_shift = models.ForeignKey(Shift, related_name='exchanging_req_shift', on_delete=models.CASCADE, blank=True, null=True)
    ...
    replacing_req_shift_label = models.CharField(max_length=3, blank=True, null=True)
    replacing_req_shift = models.ForeignKey(Shift, related_name='replacing_req_shift', on_delete=models.CASCADE, blank=True, null=True)

...
from .views import abscences_page, submit_csl, view_csl_application, delete_csl, edit_csl, submit_usl, view_usl_application, delete_usl, edit_usl, submit_fm, view_fm_application, delete_fm, edit_fm, view_staff_sick_leave_applications, view_my_sick_leave, accept_csl, reject_csl, accept_usl, reject_usl

...
urlpatterns = [
    ...
    url(r'^search_nsot/$', search_nsot, name='search_nsot'),
    url(r'^search_previous_ot/$', search_previous_ot, name='search_previous_ot'),
    ...
    url(r'^(?P<st_date_selected>\d{4}-\d{2}-\d{2})/assign_st_ot_require/$', assign_st_ot_require, name='assign_st_ot_require'),
]